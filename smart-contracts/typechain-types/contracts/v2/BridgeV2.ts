...
export interface BridgeV2Interface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "upgradeInitialize",
...
export interface BridgeV2 extends BaseContract {
  ...
  testUpgrade: TypedContractMethod<[], [void], "nonpayable">;
  ...
  upgradeInitialize: TypedContractMethod<
    [
      _asset: AddressLike,
      _authority: AddressLike,
  ...
  >;
  getFunction(
    nameOrSignature: "upgradeInitialize"
  ): TypedContractMethod<
    [
      _asset: AddressLike,
      _authority: AddressLike,
  ...
  getEvent(
    ...
    HealthEvent.InputTuple,
    HealthEvent.OutputTuple,
    HealthEvent.OutputObject
  >;
  getEvent(
    key: "Initialized"
  ): TypedContractEvent<
  ...
  filters: {
    "Health(string)": TypedContractEvent<
      HealthEvent.InputTuple,
      HealthEvent.OutputTuple,
      HealthEvent.OutputObject
    >;
    Health: TypedContractEvent<
      HealthEvent.InputTuple,
      HealthEvent.OutputTuple,
      HealthEvent.OutputObject
    >;
