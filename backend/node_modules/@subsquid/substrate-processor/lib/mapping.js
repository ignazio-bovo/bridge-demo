...
exports.Event = Event;
_Event_block = new WeakMap(), _Event_extrinsic = new WeakMap(), _Event_call = new WeakMap(), _Event_evmLogAddress = new WeakMap(), _Event_evmLogTopics = new WeakMap(), _Event_contractAddress = new WeakMap(), _Event_gearProgramId = new WeakMap();
class Block {
    constructor(header) {
        this.header = header;
        this.extrinsics = [];
