...
import { CallRequest, ContractsContractEmittedRequest, EthereumTransactRequest, EventRequest, EvmLogRequest, GearMessageQueuedRequest, GearUserMessageSentRequest } from './interfaces/data-request';
